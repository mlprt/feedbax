...
- Verify: I think both Lillicrap & Scott & Todorov & Li use averages of 
  slow/fast twitch params
...
class VirtualMuscle(eqx.Module):
    ...
    # TODO: none of the models I'm using implement the Y or l_eff filters.    
